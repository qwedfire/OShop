...
<sql:setDataSource
	...
	url="jdbc:mysql://localhost/oshop"
	user="root"
	password="root"
	/>
<%
...
%>
<!-- 		SELECT * FROM cart WHERE username = '劉冠儒' -->
<sql:query var="rs1">
								...
								<div class="payment">
									...
									<div>
											<a class="btn btn-main btn-checkout"
										       data-e2e-id="checkout_button" href="<c:url value='/cart2'/>"
							...
							<div class="block">
								...
								<ul class="summary-prices">
									<li><span style="font-size: 16px">小計:</span> <span
										class="price" style="font-size: 16px">${totalCost }</span></li>
												...
												<div id="delivery-form-content">
													...
													<div id="family-mart-address" checkout-delivery-family-mart
														...
														<div class="form-group">
															...
															<br>
															<br>
															<div class="btn btn-success btn-block btn-pick-store" style="font-size: 16px">
																搜尋門市
															</div>
														</div>
													</div>
...
<!-- 		訂單結帳>>>>>綠界   開啟新分頁的寫法 -->
		<script>
			function openPaymentPage(){
				var paymentUrl = '<c:url value="/pay"/>';
