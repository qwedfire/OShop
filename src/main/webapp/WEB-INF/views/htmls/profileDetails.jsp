...
<!-- 	第二個style.css是原本的故意放後面讓他覆蓋前面重複的部分! -->
<!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script> -->
<!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js"></script> -->
<!-- 	上面兩個src 不能用 否則無法出現選單= = -->
...
<!-- 									<div style="text-align: center;"> -->
<%-- 										<a href="<c:url value=''/>" class="btn btn-transparent mt-20" --%>
<!-- 											style="font-size: 14px;">更換大頭貼</a> -->
<!-- 									</div> -->
								</div>
							</div>
							<div class="media-body">
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											...
											<button id="oshopProfileDetailclose1" type="button" class="close" data-bs-dismiss="modal"
												aria-label="Close">
										...
										<form action="<c:url value='/editProfile' />" method="post"
											...
											<div class="modal-footer">
												<button id="oshopProfileDetailclose2" type="button" class="btn btn-secondary"
