	...
	<section class="about section">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5">
					<img class="img-responsive" src="images/oShopBlack.png" style="width: 220px; height: 300px; padding-top: 35px;">
				</div>
				<div class="col-md-6">
					<h2 class="mt-40" style="font-size: 55px;">關於Original Shop</h2>
					<br>
					<br>
					<p style="font-size: 20px">我們是Original Shop，是一個3C的店商平台，隨著網路消費的日益普及，越來越多人開始在網路上購物，並且對於3C電子產品的需求也不斷增加。</p>
					<p style="font-size: 20px">因此，我們開發一個類似於原價屋3C購物網的網路購物平台，為消費者提供方便、快捷、實惠的購物體驗。</p>
					<br>
					<br>
					<!-- *** 跳轉頁面 聯絡我們 *** -->
					<a href="<c:url value='/contact'/>" class="btn btn-main mt-20" style="font-size: 18px">聯絡我們</a>
				</div>
			</div>
			<br>
			<br>
...
<!-- 			</div> -->
	...
	<section class="team-members ">
		<div class="container">
			<div class="row">
				<div class="title">
					<h2 style="font-size: 40px; text-transform:capitalize;" >Original Shop 團隊成員</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="team-member text-center">
						<img style="width: 60%; height: 60%" class="img-circle" src="images/team/meber.png">
						<h3>賴芊坊</h3>
						<p style="font-size: 20px;">Front-end Engineer</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="team-member text-center">
						<img style="width: 60%; height: 60%" class="img-circle" src="images/team/meber1.png">
						<h3>劉冠儒</h3>
						<p style="font-size: 20px;">Back-end Engineer</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="team-member text-center">
						<img style="width: 60%; height: 60%" class="img-circle" src="images/team/meber3.png">
						<h3>陳書玄</h3>
						<p style="font-size: 20px;">Database Engineer</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
					<div class="team-member text-center">
						<img  style="width: 60%; height: 60%" class="img-circle" src="images/team/meber4.png">
						<h3>林宇祥</h3>
						<p style="font-size: 20px;">Database Engineer</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="team-member text-center">
						<img  style="width: 60%; height: 60%" class="img-circle" src="images/team/meber5.png">
						<h3>林宸儀</h3>
						<p style="font-size: 20px;">Full-Stack Engineer</p>
					</div>
				</div>
				<div class="col-md-4">
					<div class="team-member text-center">
						<img  style="width: 60%; height: 60%" class="img-circle" src="images/team/meber6.png">
						<h3>張佳琳</h3>
						<p style="font-size: 20px;">Front-end Engineer</p>
					</div>
				</div>
...
<!-- 					* 千 * -->
<%-- 					<a href="<c:url value='https://www.youtube.com/watch?v=oyEuk8j8imI&amp;rel=0'/>" --%>
<!-- 						class="play-icon" data-toggle="lightbox"> -->
