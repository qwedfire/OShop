package com.example.oshop.ecpay.payment.integration.ecpayOperator;
...
public class PaymentVerifyBase{
	protected String confPath = "/com/example/oshop/ecpay/payment/integration/config/EcpayPayment.xml";

	protected Document doc;
	public PaymentVerifyBase(){
//		URL fileURL = this.getClass().getResource(confPath);
		URL fileURL = this.getClass().getClassLoader().getResource("EcpayPayment.xml");
