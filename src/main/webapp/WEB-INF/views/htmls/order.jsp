					...
					<div class="dashboard-wrapper user-dashboard">
						<div class="table-responsive">
							<table class="table">
								<thead>
									<tr>
										<th style="font-size: 16px;">訂單編號</th>
										<th style="font-size: 16px;">訂單日期</th>
										<th style="font-size: 16px;">項目</th>
										<th style="font-size: 16px;">合計</th>
										<th style="font-size: 16px;">訂單狀態</th>
										<th style="font-size: 16px;"></th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td style="font-size: 16px;">#123456</td>
										<td style="font-size: 16px;">2023-05-18</td>
										<td style="font-size: 16px;">2</td>
										<td style="font-size: 16px;">$99.00</td>
										<td style="font-size: 16px;"><span class="label label-primary">已確認</span></td>
										<td style="font-size: 16px;"><a href="<c:url value='/order'/>" class="btn btn-default">查閱</a></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">#123456</td>
										<td style="font-size: 16px;">2023-05-18</td>
										<td style="font-size: 16px;">3</td>
										<td style="font-size: 16px;">$150.00</td>
										<td style="font-size: 16px;"><span class="label label-success">已確認</span></td>
										<td style="font-size: 16px;"><a href="<c:url value='/order'/>" class="btn btn-default">查閱</a></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">#123456</td>
										...
										<td style="font-size: 16px;">3</td>
										<td style="font-size: 16px;">$150.00</td>
										<td style="font-size: 16px;"><span class="label label-danger">已確認</span></td>
										<td style="font-size: 16px;"><a href="<c:url value='/order'/>" class="btn btn-default">查閱</a></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">#123456</td>
										...
										<td style="font-size: 16px;">2</td>
										<td style="font-size: 16px;">$99.00</td>
										<td style="font-size: 16px;"><span class="label label-info">已確認</span></td>
										<td style="font-size: 16px;"><a href="<c:url value='/order'/>" class="btn btn-default">查閱</a></td>
									</tr>
									<tr>
										<td style="font-size: 16px;">#123456</td>
										...
										<td style="font-size: 16px;">3</td>
										<td style="font-size: 16px;">$150.00</td>
										<td style="font-size: 16px;"><span class="label label-warning">已確認</span></td>
										<td style="font-size: 16px;"><a href="<c:url value='/order'/>" class="btn btn-default">查閱</a></td>
									</tr>
								</tbody>
							</table>
