...
//			String paymentConfPath = "C:/_SpringBoot/spring-boot-workspace/demo-1/payment_conf.xml";
			
			Resource resource = new ClassPathResource("payment_conf.xml");
			String paymentConfPath = "";
			try {
				paymentConfPath = resource.getFile().getAbsolutePath();
			} catch (IOException e) {
				// TODO Auto-generated catch block
				System.out.println("配置文件空值");
				e.printStackTrace();
			}
