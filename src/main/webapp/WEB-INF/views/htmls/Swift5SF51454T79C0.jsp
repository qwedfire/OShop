        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <!-- *** 跳轉頁面 *** -->
              ...
              <li style="font-size: 18px"><a href="<c:url value='/shop'/>">Swift 5</a></li>
              <li style="font-size: 18px" class="active">SF514-54T-79C0</li>
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img
                        ...
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-1.png"
                      />
                    </div>
                    <div class="item">
                      <img
                        src="images/single-product/SF514-54T-79C0/SF514-54T-79C0-2.png"
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-2.png"
                      />
                    </div>
                    <div class="item">
                      <img
                        src="images/single-product/SF514-54T-79C0/SF514-54T-79C0-3.png"
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-3.png"
                      />
                    </div>
                    <div class="item">
                      <img
                        src="images/single-product/SF514-54T-79C0/SF514-54T-79C0-4.png"
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-4.png"
                      />
                    </div>
                    <div class="item">
                      <img
                        src="images/single-product/SF514-54T-79C0/SF514-54T-79C0-5.png"
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-5.png"
                      />
                    </div>
                    <div class="item">
                      <img
                        src="images/single-product/SF514-54T-79C0/SF514-54T-79C0-6.png"
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-6.png"
                      />
                    </div>
                    <div class="item">
                      <img
                        src="images/single-product/SF514-54T-79C0/SF514-54T-79C0-7.png"
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-7.png"
                      />
                    </div>
                    <div class="item">
                      <img
                        src="images/single-product/SF514-54T-79C0/SF514-54T-79C0-8.png"
                        alt=""
                        data-zoom-image="images/single-product/SF514-54T-79C0/SF514-54T-79C0-8.png"
                      />
                    </div>
                  </div>
          ...
          <div class="col-md-6">
            <div class="single-product-details">
              ...
              <p class="product-description mt-20" style="font-size: 20px">
                Swift 5 是最輕巧的1 14 吋掀蓋式筆記型電腦，僅 990
                公克的重量搭配強大的 NVIDIA®
                顯示卡，專為全天攜帶外出工作娛樂而設計。 本產品亦搭載最新 Intel®
                Core™ CPU，機身厚度僅 14.95 公釐，強大設計值得您信賴。
              </p>
              ...
              <div class="price">
                ...
                <span class="new-price">$42,900</span>
              </div>
                ...
                <div id="details" class="tab-pane fade active in">
                  <div>
                    ...
                    <div class="container222">
                      ...
                      <div class="item222">Windows 10 家用版</div>
                  ...
                  <div>
                    ...
                    <div class="container222">
                      ...
                      <div class="item222">i7-1065G7</div>
                      <div class="item222">處理器速度</div>
                      <div class="item222">1.30 GHz</div>
                      <div class="item222">處理器核心數</div>
                      <div class="item222">四核（四個核心）</div>
                      <div class="item222">處理器世代</div>
                      <div class="item222">第 10 代</div>
                      <div class="item222">vPro技術</div>
                  ...
                  <div>
                    ...
                    <div class="container222">
                      ...
                      <div class="item222">USB 2.0 連接埠數量</div>
                      <div class="item222">1</div>
                      <div class="item222">USB 3.1 Gen 1 Type-A 連接埠數量</div>
                      <div class="item222">1</div>
                      <div class="item222">USB 3.1 Gen 2 Type-C 連接埠數量</div>
                      <div class="item222">1</div>
                  ...
                  <div>
                    ...
                    <div class="container222">
                      ...
                      <div class="item222">12 小時</div>
                      <div class="item222">電池效能功率</div>
                      <div class="item222">56 Wh</div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="container222">
                      ...
                      <div class="item222">14.95 mm</div>
                      <div class="item222">寬</div>
                      <div class="item222">318.7 mm</div>
                      <div class="item222">深</div>
                      <div class="item222">210.5 mm</div>
                      <div class="item222">重量（大約）</div>
                      <div class="item222">990 g</div>
                      <div class="item222">產品顏色</div>
                      <div class="item222">白色</div>
                    </div>
                  </div>
                    ...
                    <ul class="media-list comments-list m-bot-50 clearlist">
                        ...
                        <div class="media-body">
                          <div class="comment-info">
                            <h4 class="comment-author">
                              <a href="<c:url value=''/>">a******8</a>
                            </h4>
                            <time datetime="2013-04-06T13:53"
                              >May 15, 2023, AM 11:35</time
                            >
                        ...
                        <div class="media-body">
                          <div class="comment-info">
                            <div class="comment-author">
								<a href="<c:url value=''/>">e******3</a>
                            </div>
                            <time datetime="2013-04-06T13:53"
                              >May 13, 2023, PM 16:02</time
                            >
                      ...
                      <li class="media">
                        ...
                        <div class="media-body">
                          <div class="comment-info">
                            <div class="comment-author">
                              <a href="<c:url value=''/>">r******5</a>
                            </div>
                            <time datetime="2013-04-06T13:53"
                              >May 01, 2023, AM 08:10</time
                            >
                            <a class="comment-button" href="#!"
                              ><i class="tf-ion-chatbubbles"></i>回覆</a
                            >
