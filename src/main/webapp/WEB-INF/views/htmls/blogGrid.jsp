      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="post">
              ...
              <h2 class="post-title">
                <a href="blog-single.html">如何挑選適合的配件</a>
              </h2>
              <div class="post-meta">
                <ul>
                  <li><i class="tf-ion-ios-calendar"></i> 20, 03 2017</li>
                  <li><i class="tf-ion-android-person"></i>由管理員發布</li>
                  <li>
                    <a href="blog-grid.html"
                      ><i class="tf-ion-ios-pricetags"></i> 生活方式</a
                    >,<a href="blog-grid.html"> 旅行</a>,
                    <a href="blog-grid.html"> 時尚</a>
                  </li>
                  <li>
                    <a href="#!"
                      ><i class="tf-ion-chatbubbles"></i> 4條評論</a
                    >
                  </li>
                </ul>
              </div>
              <div class="post-content">
                ...
                <a href="blog-single.html" class="btn btn-main"
                  >繼續閱讀</a
                >
              </div>
            </div>
            ...
            <div class="post">
              <div class="post-media post-media-audio">
                <iframe
                  ...
                  class="DRAGDIS_iframe"
                ></iframe>
              </div>
              <h2 class="post-title">
                <a href="blog-single.html">標準音頻後期</a>
              </h2>
              <div class="post-meta">
                <ul>
                  ...
                  <li>
                    <a href="blog-full-width.html"
                      ><i class="tf-ion-ios-pricetags"></i> 生活方式</a
                    >,<a href="blog-full-width.html"> 旅行</a>,
                    <a href="blog-full-width.html"> 時尚</a>
                  </li>
                  <li>
                    <a href="#!"
                      ><i class="tf-ion-chatbubbles"></i> 4條評論</a
            ...
            <div class="post">
              <div class="post-media post-media-audio">
                <iframe
                  width="100%"
                  height="400"
                  src="https://www.youtube.com/embed/Ljik3zsGNF4"
                  frameborder="0"
                  allowfullscreen
                ></iframe>
              </div>
              <h2 class="post-title">
                <a href="blog-single.html">標準視頻後期</a>
              </h2>
              <div class="post-meta">
                <ul>
                  <li><i class="tf-ion-ios-calendar"></i> 20, 03 2017</li>
        ...
        <div class="text-center">
          <ul class="pagination post-pagination">
            <li><a href="blog-left-sidebar.html">Prev</a></li>
            <li class="active"><a href="blog-left-sidebar.html">1</a></li>
            <li><a href="blog-left-sidebar.html">2</a></li>
            <li><a href="blog-left-sidebar.html">3</a></li>
            <li><a href="blog-left-sidebar.html">4</a></li>
            <li><a href="blog-left-sidebar.html">5</a></li>
            <li><a href="blog-left-sidebar.html">Next</a></li>
          </ul>
        </div>
      </div>
    </div>
