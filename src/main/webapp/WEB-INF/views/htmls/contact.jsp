					...
					<div class="contact-form col-md-6 ">
						<form id="contact-form" method="post" action="" role="form">
							...
							<div class="form-group">
								<input type="text" placeholder="你的名字" class="form-control" name="name" id="name" style="font-size: 16px;">
							</div>
							...
							<c:choose >
								<c:when test="${not empty sessionScope.user}">
									...
									<input type="email" value="${user.email}" placeholder="你的電郵" class="form-control" name="email" id="email" style="font-size: 16px;">
<%-- 									<input type="email" value="${user.password}" placeholder="你的電郵" class="form-control" name="email" id="email" style="font-size: 16px;"> --%>
								</c:when>
								<c:otherwise>
									<input type="email" placeholder="你的電郵" class="form-control" name="email" id="email" style="font-size: 16px;">
								</c:otherwise>	
							</c:choose>
							</div>
							...
							<div class="form-group">
								<input type="text" placeholder="標題" class="form-control" name="subject" id="subject" style="font-size: 16px;">
							</div>

							<div class="form-group">
								<textarea rows="6" placeholder="訊息" class="form-control" name="message" id="message" style="font-size: 16px;"></textarea>
							</div>
							...
							<div id="cf-submit">
								<input type="submit" id="contact-submit" class="btn btn-transparent" value="送出" style="font-size: 16px;">
							</div>
					...
					<div class="contact-details col-md-1 ">
					</div>
					...
					<div class="contact-details col-md-4 ">
						<div class="google-map">
							<iframe
								src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3640.6044315976305!2d120.65100830000002!3d24.150526199999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x34693d964fff6dc5%3A0x5d526ce61b5b9ca6!2zNDA45Y-w5Lit5biC5Y2X5bGv5Y2A5YWs55uK6Lev5LqM5q61NTHomZ8!5e0!3m2!1szh-TW!2stw!4v1679753923080!5m2!1szh-TW!2stw"
						...
						<ul class="contact-short-info">
							<li>
								<i class="tf-ion-ios-home" style="font-size: 18px;"></i>
								<span style="font-size: 18px;">台中市南屯區公益路二段51號</span>
							</li>
							<li>
								<i class="tf-ion-android-phone-portrait" style="font-size: 18px;"></i>
								<span style="font-size: 18px;">電話 : +886-09-12-345-678</span>
							</li>
							<li>
								<i class="tf-ion-android-globe" style="font-size: 18px;"></i>
								<span style="font-size: 18px;">傳真 : +886-09-12-345-678</span>
							</li>
							<li>
								<i class="tf-ion-android-mail" style="font-size: 18px;"></i>
								<span style="font-size: 18px;">電子信箱 : nihow@example.com</span>
							</li>
						</ul>
					</div>
					<!-- / End Contact Details -->
