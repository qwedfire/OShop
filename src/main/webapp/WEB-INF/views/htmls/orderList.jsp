			...
			<div class="row">
				<div class="col-md-12">
					<ul class="list-inline dashboard-menu text-center">
						...
						<li><a class="active" href="<c:url value='/orderList'/>" style="font-size: 16px;">追蹤清單</a></li>
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th style="font-size: 16px;">購買狀態</th>
										<th style="font-size: 16px;">刪除</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>
											<div>
												<img src="images/oshop.jpeg" width="80" />
											</div>
										</td>
										<td style="vertical-align:middle; font-size: 16px;">TEAM十銓MP34 1TB M.2 Gen3 x4 SSD/3400/2900MBs
										</td>
										<td style="vertical-align:middle; font-size: 16px;" >NT$1000</td>
										<td style="vertical-align:middle; font-size: 16px;" ><span
												class="label label-primary">加入購物車</span></td>
									...
									<tr>
										...
										<td style="vertical-align:middle; font-size: 16px;">NT$1000</td>
										<td style="vertical-align:middle; font-size: 16px;"><span class="label label-danger">已售完</span>
										</td>
										<td style="vertical-align:middle;">
											<div class="btn-group" role="group">
												<button type="button" class="btn btn-default"><i class="tf-ion-close"
