			...
			<div class="row">
				<div class="col-md-12">
					<ul class="list-inline dashboard-menu text-center">
						...
						<li><a class="active" href="<c:url value='/dashboard'/>" style="font-size: 16px;">商店購物金</a></li>
						<li><a href="<c:url value='/order'/>" style="font-size: 16px;">我的訂單</a></li>
					...
					<div class="dashboard-wrapper user-dashboard">
						<div class="media">
							<div class="media-body">
								<h2 class="media-heading" style="font-size: 20px;"><b>現有購物金</b> 0</h2>
							</div>
						</div>
						<div class="total-order mt-20">
							<h4 style="font-size: 18px;">購物金紀錄</h4>
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th style="font-size: 16px;">日期</th>
											<th style="font-size: 16px;">購物金項目</th>
											<th style="font-size: 16px;">購物金款項</th>
											<th style="font-size: 16px;">到期日</th>
											<th style="font-size: 16px;">購物金餘額</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td style="font-size: 16px;">2022-12-23</td>
											<td style="font-size: 16px;"><a href="<c:url value=''/>">#252125</a></td>
										...
										<tr>
											...
											<td style="font-size: 16px;">2</td>
											<td style="font-size: 16px;">2023-05-18</td>
											<td style="font-size: 16px;">$ 90.00</td>
										</tr>
										<tr>
											<td style="font-size: 16px;">2022-12-23</td>
											<td style="font-size: 16px;"><a href="<c:url value=''/>">#252125</a></td>
											<td style="font-size: 16px;">2</td>
											<td style="font-size: 16px;">2023-05-18</td>
											<td style="font-size: 16px;">$ 80.00</td>
										</tr>
									</tbody>
								</table>
							</div>
