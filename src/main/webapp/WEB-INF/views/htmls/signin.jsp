        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <div class="block text-center">
              ...
              <form class="text-left clearfix" action="<c:url value='/register'/>" method="post"  enctype='multipart/form-data' >
                <div class="form-group">
                  <input
                    ...
                    style="font-style: monospace; font-weight: bold; font-size: 14px"
                  />
                </div>
                <div class="form-group">
                  <input
