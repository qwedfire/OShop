			...
			<div class="row">
				<div class="col-md-12">
					<div class="content">
						...
						<ol class="breadcrumb">
						<!-- *** 跳轉 回到首頁 *** -->
							<li><a href="<c:url value='/index4'/>">首頁</a></li>
...
<!-- 														<input type="number" id="quantity" name="quantity" min="1" max="5"> -->
									...
									<!-- *** 頁面跳轉 *** -->
									<a href="<c:url value='/checkout2'/>" class="btn btn-main pull-right" style="font-size: 16px; margin-right: 33px;">前往結帳</a>
								</form>
							</div>
						</div>
					</div>
